        ...
        >
          <div className="flex items-center border-b px-3">
            ...
            <Command.Input
              ...
              className="flex h-12 w-full rounded-md bg-transparent py-3 text-sm outline-none focus:ring-0 placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 border-none"
            />
