...
export const Button: FC<ButtonProps> = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'primary', size = 'md', isLoading, children, className = '', ...props }, ref) => {
    ...
    const variants = {
      ...
      'fluid-primary': 'text-white shadow-lg hover:shadow-xl animate-fluid-primary',
      'fluid-secondary': 'text-white shadow-lg hover:shadow-xl animate-fluid-secondary',
      'fluid-accent': 'text-white shadow-lg hover:shadow-xl animate-fluid-accent',
    };
